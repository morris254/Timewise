                                            ...
                                            <ul class="list-unstyled">
                                                <li>
                                                    <a href="#">
                                                        ...
                                                        <p class="msg-text">Hey ! I'm working on your errand</p>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink open active"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-gift"></span><p>Extra</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <div class="events">
                                        <div class="calendar-event"><p>Cheque deposit to Equity Bank</p><a href="javascript:void(0);" class="remove-calendar-event"><i class="fa fa-remove"></i></a></div>
                                        <div class="calendar-event"><p>book a ticket</p><a href="javascript:void(0);" class="remove-calendar-event"><i class="fa fa-remove"></i></a></div>
                                        <div class="calendar-event"><p>pick my suit from jamia</p><a href="javascript:void(0);" class="remove-calendar-event"><i class="fa fa-remove"></i></a></div>
                                        <div class="calendar-event"><p>deliver flowers to jacaranda estate</p><a href="javascript:void(0);" class="remove-calendar-event"><i class="fa fa-remove"></i></a></div>
                                        <div class="calendar-event"><p>Cheque deposit NIC bank Yaya Branch</p><a href="javascript:void(0);" class="remove-calendar-event"><i class="fa fa-remove"></i></a></div>
                                    </div>
                                    <input class="form-control add-event" type="text" placeholder="Add Errand service">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8">
