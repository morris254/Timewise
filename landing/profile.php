                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 user-profile">
                            <h3 class="text-center">Morris Muli</h3>
                            <p class="text-center">Company name</p>
                            <hr>
                            <ul class="list-unstyled text-center">
                                <li><p><i class="fa fa-map-marker m-r-xs"></i>Karen, Nairobi</p></li>
                                <li><p><i class="fa fa-envelope m-r-xs"></i><a href="#">example@mail.com</a></p></li>
                               <!-- <li><p><i class="fa fa-link m-r-xs"></i><a href="#">www.ifavailable.net</a></p></li>-->
                            </ul>
                            <hr>
                            <button class="btn btn-primary btn-block"><i class="fa fa-plus m-r-xs"></i>Add sub-User</button>
                        </div>
